        ...
        <div style="padding: 30px; background-color: #f8f9fa;">
          ...
          <div style="background: white; border-radius: 10px; padding: 25px; margin: 25px 0; border-left: 4px solid #667eea;">
            ...
            <div style="background: #f1f3f4; padding: 15px; border-radius: 8px; margin: 15px 0;">
              <p style="margin: 5px 0;"><strong>Portal URL:</strong> <a href="https://innoverse-n.vercel.app/login" style="color: #667eea;">https://innoverse-n.vercel.app/login</a></p>
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="https://innoverse-n.vercel.app/login" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 15px 30px; text-decoration: none; border-radius: 25px; font-weight: bold; display: inline-block;">
              🚀 Access Team Portal
            </a>
          </div>
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 30px; background-color: #f8f9fa;">
          ...
          <div style="background: white; border-radius: 10px; padding: 25px; margin: 25px 0; border-left: 4px solid #8e2de2;">
            ...
            <div style="background: #f1f3f4; padding: 15px; border-radius: 8px; margin: 15px 0;">
              <p style="margin: 5px 0;"><strong>Portal URL:</strong> <a href="https://innoverse-n.vercel.app/login" style="color: #8e2de2;">https://innoverse-n.vercel.app/login</a></p>
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="https://innoverse-n.vercel.app/login" style="background: linear-gradient(135deg, #8e2de2 0%, #4a00e0 100%); color: white; padding: 15px 30px; text-decoration: none; border-radius: 25px; font-weight: bold; display: inline-block;">
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 30px; background-color: #f8f9fa;">
          ...
          <div style="background: white; border-radius: 10px; padding: 25px; margin: 25px 0; border-left: 4px solid #1e3c72;">
            ...
            <div style="background: #f1f3f4; padding: 15px; border-radius: 8px; margin: 15px 0;">
              <p style="margin: 5px 0;"><strong>Portal URL:</strong> <a href="https://innoverse-n.vercel.app/login" style="color: #1e3c72;">https://innoverse-n.vercel.app/login</a></p>
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="https://innoverse-n.vercel.app/login" style="background: linear-gradient(135deg, #1e3c72 0%, #2a5298 100%); color: white; padding: 15px 30px; text-decoration: none; border-radius: 25px; font-weight: bold; display: inline-block;">
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 30px; background-color: #f8f9fa;">
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="https://innoverse-n.vercel.app/login" style="background: linear-gradient(135deg, #ff6b6b 0%, #ee5a52 100%); color: white; padding: 15px 30px; text-decoration: none; border-radius: 25px; font-weight: bold; display: inline-block;">
