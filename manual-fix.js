...
async function manualFix() {
  try {
    ...
    // Connect to MongoDB (using the connection string from your debug logs)
    await mongoose.connect('mongodb+srv://leelamadhav:8pP0fh8GJ4JcKlDq@cluster0.fhipcg5.mongodb.net/innoverse?retryWrites=true&w=majority');
